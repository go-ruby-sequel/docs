...
Contributions are welcome. `go-ruby-sequel/sequel` is built to a small set of
...
The library is in [`github.com/go-ruby-sequel/sequel`](https://github.com/go-ruby-sequel/sequel).
This documentation site is in [`github.com/go-ruby-sequel/docs`](https://github.com/go-ruby-sequel/docs).
