...
The public API lives at the module root (`github.com/go-ruby-sequel/sequel`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `sequel`, while the surface follows
...
```go
import "github.com/go-ruby-sequel/sequel"
```
...
- **[pkg.go.dev/github.com/go-ruby-sequel/sequel](https://pkg.go.dev/github.com/go-ruby-sequel/sequel)**

The module's [README](https://github.com/go-ruby-sequel/sequel#readme) carries worked
