...
`go-ruby-sequel/sequel` reimplements Ruby's `sequel` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-sequel/sequel` directly, with no Ruby runtime;
